...
class ThreeHour extends StatefulWidget {
  ThreeHour({this.cityNames});
  final String cityNames;
  @override
  _ThreeHourState createState() => _ThreeHourState();
}

class _ThreeHourState extends State<ThreeHour> {
  int temperatures;
  String city;
